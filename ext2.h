...
/* The number of blocks in an image file used for this assignment */
 ...
 */
/* Root inode index */
#define    EXT2_ROOT_INO_IDX         1
/* Index of first non-reserved inode for old ext2 filesystems */
#define EXT2_GOOD_OLD_FIRST_INO_IDX 11
